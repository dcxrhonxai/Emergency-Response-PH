...
const roadmapData: FeatureCategory[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Medication Reminders", completed: true },
      { name: "Allergy Alerts", completed: true },
      { name: "Doctor Contact Integration", completed: true },
      { name: "Offline Medical ID Card", completed: true },
      { name: "Live Video Streaming", completed: true },
    ],
  },
  {
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Firebase Analytics", completed: true },
      { name: "Firebase Crashlytics", completed: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Service Worker", completed: true },
      ...
      { name: "Haptic Feedback", completed: true },
    ],
  },
  {
    ...
    features: [
      ...
      { name: "Additional Languages (5 languages)", completed: true },
      { name: "Screen Reader Support", completed: true },
      { name: "High Contrast Mode", completed: true },
