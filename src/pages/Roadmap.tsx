...
const roadmapData: FeatureCategory[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Live Video Streaming", completed: false, priority: "high" },
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Push Notifications", completed: false, priority: "high" },
      { name: "In-App Notifications", completed: false, priority: "medium" },
      { name: "Voice Call Integration", completed: false, priority: "high" },
      { name: "Group Messaging", completed: false, priority: "low" },
    ],
  },
  {
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Medical History", completed: false, priority: "high" },
      { name: "Medication Tracking", completed: false, priority: "medium" },
      { name: "Allergy Alerts", completed: false, priority: "high" },
      { name: "Doctor Contact Integration", completed: false, priority: "low" },
    ],
  },
  {
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Security Audit Logging", completed: false, priority: "high" },
    ],
  },
  {
